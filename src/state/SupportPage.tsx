    ...
    return (<UserShell>
        <div className='relative min-h-[82vh]'>
            <Card className='mt-[30px] border border-gray-200' shadow='xs' p='lg'>
                ...
                <ReactPlayer controls={true} url={'https://firebasestorage.googleapis.com/v0/b/care-insights.appspot.com/o/CareInsights%20walkthrough.mp4?alt=media&token=684e9067-680c-48bf-84c9-a03eb99941ad'} />
                {/* <LiteYouTubeEmbed
                ...
                <ReactPlayer controls={true}  url={'https://firebasestorage.googleapis.com/v0/b/care-insights.appspot.com/o/Study-announcment.mp4?alt=media&token=80570323-8914-41fe-a5e1-1eacf46dff08'} />
                {/* <LiteYouTubeEmbed
                    id="xzXpYwPHkKU"
                    rel="0"
                    title="Care Insights Onboarding Intro"
