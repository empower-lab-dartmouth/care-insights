...
export async function getRelevantQueries(inputQuery: string,
    allCRQueries: Record<string, QueryRecord>) {
        // Filter out unapproved queries.
        const approvedQueries: QueryRecord[] = Object.values(allCRQueries)
...
// TODO: Bansharee (helper function)
export async function getRelevantRecords(inputQuery: string,
