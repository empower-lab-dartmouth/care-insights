...
const responseChip = (loading: boolean,
    queryModified: boolean, pageState: PageState,
...
const QuestionAndAnswerPanel: React.FC = () => {
    ...
    const alreadyApproved = pageContext.
        insightsQuery.dateApproved !== undefined &&
        ...
        <>
            <Paper elevation={1}
                ...
                <Stack direction={'row'}>
                    ...
                    {
                        responseChip(loadingResponse, queryModified,
                            pageContext, alreadyApproved)
                    }
                </Stack>
                ...
                />
                {
                    queryModified ? <></> :
                        <>
                            <Typography variant="h6" gutterBottom>
                                Our AI learns from your feedback!
                                Please improve the model with a review:
                            </Typography>
                            {feedbackInputOpen ?
                            ...
                            <Stack direction={'row'}>
                                <Button startIcon={<EditIcon />}
                                    ...
                                    Let me just fix something... </Button>
