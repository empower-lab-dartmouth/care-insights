...
//         value: row[attentionColumnName] * 100,
//         startDate,
//     },{
//         date,
...
//   const START_DATE_CONST = new Date();
//   const startDateString = START_DATE_CONST.toDateString();
//   const END_DATE = new Date(START_DATE_CONST.getTime() + (100 * ONE_DAY));
//   const [startDate, setStartDate] = useState(START_DATE_CONST); // "2015-01-01"
...
//     //   const csvData = await json2csv(sampleHeatmapData);
